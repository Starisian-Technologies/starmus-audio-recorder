...
final class StarmusShortcodeLoader
{
     ...
     */
    public function __construct(?StarmusAudioDAL $dal = null, ?StarmusSettings $settings = null, ?StarmusProsodyDAL $prosody_dal = null, ?SparxstarAppMode $appMode = null)
    {
        try {
    ...
    public function starmus_render_script_recorder(array $atts = []): string
    {
