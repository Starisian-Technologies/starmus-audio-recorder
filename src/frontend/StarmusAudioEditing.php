<?php
/**
 * Manages the front-end audio editing interface and user's recordings list.
 *
...
use Starisian\src\includes\StarmusAdminSettings;
...
class StarmusAudioEditing {
    
    public function __construct() {
        add_shortcode('starmus_audio_recorder', [ $this, 'render_starmus_recordings_shortcode' ]);
   ...
   /**
	 ...
	 */
	public function render_starmus_recordings_shortcode(): string {
