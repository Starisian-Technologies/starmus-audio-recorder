...
final class StarmusPostTypeLoader implements IContentBundle
{
	...
	public function sparxStarmusRegister(): void
	{
		add_action('acf/include_fields', function () {
			...
			acf_add_local_field_group(array(
				...
				'fields' => array(
					...
					array(
						'key' => 'starmus_calibrated_pace_ms',
						'label' => 'Calibrated Pace (ms)',
						'name' => 'starmus_calibrated_pace_ms',
						'aria-label' => '',
						'type' => 'number',
						'instructions' => 'The reading speed in milliseconds per word, set by the user calibration.',
						'required' => false,
						'conditional_logic' => false,
						'wrapper' => array(
							'width' => '',
		...
		add_action('init', function () {
			...
			register_taxonomy('starmus_story_type', array(
				0 => 'starmus_transcript',
				1 => 'starmus_translate',
			), array(
				'labels' => array(
