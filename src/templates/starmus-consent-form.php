...
<div class="starmus-consent-container sparxstar-glass-card">
	...
	<form method="post" enctype="multipart/form-data" action="<?php echo esc_url(remove_query_arg('starmus_consent_submitted')); ?>">
		...
		<div class="starmus-field-group">
			...
			<p class="description"><?php esc_html_e('Upload a photo or scan of your signature.', 'starmus-audio-recorder'); ?></p>
		</div>

		<div class="starmus-form-actions">
			<button type="submit" name="starmus_consent_submit" class="button button-primary">
