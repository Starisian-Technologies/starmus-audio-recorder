		...
		<table class="starmus-info-table">
			...
			<tbody>
				<tr>
					...
					<td><?php if ($mp3_url) { ?><a href="<?php echo esc_url($mp3_url); ?>" target="_blank" download class="starmus-btn starmus-btn--outline" style="padding:4px 8px;font-size:0.8em;">Download</a><?php } ?></td>
				</tr>
				<tr>
					...
					<td><?php if ($wav_url) { ?><a href="<?php echo esc_url($wav_url); ?>" target="_blank" download class="starmus-btn starmus-btn--outline" style="padding:4px 8px;font-size:0.8em;">Download</a><?php } ?></td>
				</tr>
				<tr>
					...
					<td><?php if ($original_url) { ?><a href="<?php echo esc_url($original_url); ?>" target="_blank" download class="starmus-btn starmus-btn--outline" style="padding:4px 8px;font-size:0.8em;">Download</a><?php } ?></td>
				</tr>
			</tbody>
		</table>
	</section>
