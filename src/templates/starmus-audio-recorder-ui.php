            ...
            try {
                ...
                open1.onupgradeneeded = () => {
                    if (!open1.result.objectStoreNames.contains('recordings')) {
                        open1.result.createObjectStore('recordings', {
                            keyPath: 'id',
                            autoIncrement: true
                        });
                    }
                ...
                open2.onupgradeneeded = () => {
                    if (!open2.result.objectStoreNames.contains('queue')) {
                        open2.result.createObjectStore('queue', {
                            keyPath: 'id',
                            autoIncrement: true
                        });
                    }
                ...
                console.error('Starmus IDB Setup Error:', e);
            }
        })();
    </script>
    <form
                ...
                <div
                    ...
                    <div class="starmus-visualizer-stage">
                        ...
                        <div class="starmus-timer-wrapper">
                            <label for="starmus_timer_<?php echo esc_attr($instance_id); ?>" class="starmus-timer-label starmus-mic-stage-label""><?php esc_html_e('Recording Time:', 'starmus-audio-recorder'); ?></label>
                        ...
                        <div class="starmus-duration-progress-wrapper">
                            <label class="starmus-progress-label starmus-mic-stage-label"><?php esc_html_e('Recording Length:', 'starmus-audio-recorder'); ?></label>
                    ...
                    <div class="starmus-meter-wrap">
                        <label for="starmus_vol_meter_<?php echo esc_attr($instance_id); ?>" class="starmus-meter-label starmus-mic-stage-label"><?php esc_html_e('Microphone Volume:', 'starmus-audio-recorder'); ?></label>
                        <div id="starmus_vol_meter_<?php echo esc_attr($instance_id); ?>" class="starmus-meter-bar" data-starmus-volume-meter>
                        </div>
                    </div>
                </div>
