/**
 * @file starmus-state-store-legacy.js
 * @version 4.6.2
 * @description ES5-safe redux-like store with tier-ready support and immutability guard.
 */
...
(function (global) {
  ...
  function reducer(state, action) {
    ...
    switch (action.type) {
      ...
      // 🛡️ Immutable Tier Assignment — Once only
...
// ============================================================
// FINAL EXPORT BLOCK — SINGLE SOURCE OF TRUTH
// ============================================================

// ES module export (Rollup / modern bundlers)
// Browser global
if (typeof window !== 'undefined') {
  window.StarmusStore = window.StarmusStore || {};
  window.StarmusStore.createStore = createStore;
}

// CommonJS (Node / legacy bundlers)
if (typeof module !== 'undefined' && module.exports) {
  module.exports = { createStore };
}

// UMD fallback (very old environments)
