...
use Starisian\Starmus\core\StarmusAudioRecorderUpdater;

// Admin/UI/Assets
use Starisian\Starmus\admin\StarmusAdmin;
use Starisian\Starmus\core\StarmusAssetLoader;
use Starisian\Starmus\frontend\StarmusShortcodeLoader;
use Starisian\Starmus\frontend\StarmusAudioEditorUI; // if directly referenced (not required here)
use Starisian\Starmus\frontend\StarmusAudioRecorderUI; // if directly referenced (not required here)

// REST layer
use Starisian\Starmus\api\StarmusRESTHandler;

// Cron
use Starisian\Starmus\cron\StarmusCron;
...
final class StarmusAudioRecorder
{
	...
	private function init_settings_or_throw(): void
	{
		try {
			...
			if (class_exists(\Starisian\Starmus\core\StarmusSettings::class)) {
	...
	private function instantiate_components(): void
	{
		...
		// Updater (optional)
		try {
			if (class_exists(\Starisian\Starmus\core\StarmusAudioRecorderUpdater::class)) {
