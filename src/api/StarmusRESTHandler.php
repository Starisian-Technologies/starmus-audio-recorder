...
final class StarmusRESTHandler
{
	 ...
	 * @since 1.0.0
	 */
    private IStarmusSubmissionHandler $submission_handler;
     ...
     * @since 1.0.0
     */
    private IStarmusSettings $settings;
	...
	public function __construct(
		...
		IStarmusSettings $settings,
		?IStarmusSubmissionHandler $submission_handler = null
	) {
		$this->dal                = $dal;
