 ...
 *
 * Routes map directly to {@see StarmusSubmissionHandler} to keep logic centralized.
 */
final class StarmusRESTHandler {
	...
	/**
	 * Build the handler and register REST routes.
	 *
	 * @param StarmusAudioRecorderDAL       $dal                  Data Access Layer.
	 ...
	 */
	public function __construct( StarmusAudioRecorderDAL $dal, StarmusSettings $settings, ?StarmusSubmissionHandler $submission_handler = null ) {
		$this->dal                = $dal;
